...
We can see the averages of slope estimates β̂1 (across all tests) are close to the true parameter β1. The sample average of β̂1 across tests for which the null is rejected is closer to the true value of β1 when β1 is much different from 0. 
