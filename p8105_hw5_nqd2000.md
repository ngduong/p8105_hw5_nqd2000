...
![](p8105_hw5_nqd2000_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
is much different from 0 (except for when β1 is 0 because then the null
and alternative distributions are mostly overlapping, and thus the
rejected sample has slope estimates (different from 0) that center
around 0 and their average is close to 0).
